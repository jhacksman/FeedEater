...
export const KrakenSettingsSchema = z.object({
  enabled: z.boolean().default(false),
  apiUrl: z.string().default("wss://ws.kraken.com/v2"),
  restApiUrl: z.string().default("https://api.kraken.com/0/public"),
  whaleThreshold: z.number().positive().default(50000),
  watchedPairs: z.string().default('["XBT/USD", "ETH/USD", "SOL/USD"]'),
...
export type KrakenSettings = z.infer<typeof KrakenSettingsSchema>;
