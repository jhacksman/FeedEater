...
const DAI_ADDRESS = "0x6B175474E89094C44Da98b954EescdeCB5BE3830".toLowerCase();
...
export class UniswapCollector {
  ...
  private async storeAndPublishSwap(swap: SwapEvent, token0Info: TokenInfo, token1Info: TokenInfo): Promise<void> {
    ...
    this.nats.publish(subjectFor("uniswap", "tradeExecuted"), this.sc.encode(JSON.stringify(msgEvent)));
