...
app.delete("/api/modules/:name/cache", deleteModuleCache({ cacheStore: moduleCacheStore }));
app.get("/api/modules/:name/cache-stats", getModuleCacheStats({ cacheStore: moduleCacheStore }));
